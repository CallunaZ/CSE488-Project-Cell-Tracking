...
If you add your own feature extraction functions to src/cell_tracking/features.py,
add corresponding tests here to verify they work correctly. A test should check
that your function produces output of the expected shape, type, and value range.
"""
